            ...
            <div class="pk__container">
                <h1>
                    <div class="pk__hero_overflow-hidden">
                        <span class="pk__heading-accent pk__hero_content-reveal">Colorado Springs Digital Marketing </span>
                    </div>
                    <div class="pk__hero_overflow-hidden">
                        <span class="pk__hero_content-reveal">Creating beautiful & functional solutions for </span>
                    </div>
                    <div class="pk__hero_overflow-hidden">
                        <span class="pk__hero_content-reveal"><span class="pk__text-italic">your</span> small business</span>
                    </div>
                </h1>
                <div class="pk__hero_overflow-hidden">
